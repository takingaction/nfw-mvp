...
export const SECTION_REGISTRY: Record<SectionType, SectionDefinition> = {
  ...
  pricing_cards: {
    ...
    defaultContent: {
      ...
      cta_secondary_prefix: "",
      cta_secondary_link_label: "Sign in",
    ...
    editorFields: [
      ...
      { key: "cta_label", label: "CTA Label", type: "text" },
      { key: "cta_url", label: "CTA URL", type: "url" },
      { key: "cta_secondary_prefix", label: "Secondary Link Prefix Text", type: "text" },
      { key: "cta_secondary_text", label: "Secondary Link Text", type: "text" },
      { key: "cta_secondary_link_label", label: "Secondary Link Label", type: "text" },
      ...
      items: [
        {
          tab_label: "Grants",
          eyebrow: "Microgrants",
          headline: "Apply for microgrants up to $5,000",
          headline_italic_phrase: "",
          body: "Every month, we award microgrants to help women thrive. Apply for rent assistance, medical bills, education, and more.",
          image_url: "",
          cta_label: "Apply Now",
          cta_url: "/grants/apply",
        },
        {
          ...
          headline: "Save hundreds on everyday essentials",
          headline_italic_phrase: "",
          body: "Access exclusive discounts on groceries, gas, travel, and more. Our perks program saves members hundreds every year.",
          image_url: "",
          cta_label: "Explore Perks",
          cta_url: "/perks",
        },
        {
          tab_label: "Community",
          eyebrow: "Join the Network",
          headline: "Connect with women nationwide",
          headline_italic_phrase: "",
          body: "You're not alone. Join thousands of women sharing resources, support, and a commitment to lifting each other up.",
          image_url: "",
          cta_label: "Join Free",
          cta_url: "/auth/sign-up",
        },
