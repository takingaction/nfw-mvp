...
export const SECTION_REGISTRY: Record<SectionType, SectionDefinition> = {
  ...
  testimonials_grid: {
    ...
    defaultContent: {
      ...
      cards: [
        { quote: "I applied for a microgrant and within 48 hours I had the funds. It was such a relief.", name: "Sarah M.", role: "Member since 2023" },
        { quote: "The perks program has saved me over $400 this year alone. It's been a game-changer.", name: "Jennifer L.", role: "Founding Member" },
        { quote: "Knowing there's a community behind me makes all the difference. NFW feels like home.", name: "Maria R.", role: "Member since 2024" },
        { quote: "I love that I can claim free essentials from the Zero Dollar Store whenever I need to.", name: "Ashley T.", role: "Contributing Member" },
        { quote: "The grants helped me cover my car repairs so I could get back to work. So grateful.", name: "Demi W.", role: "Member since 2023" },
        { quote: "Being part of NFW means having people in your corner. It's more than a membership.", name: "Nicole B.", role: "Founding Member" },
      ],
      background: "dove",
    },
    editorFields: [
