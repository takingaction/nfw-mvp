  ...
  const socialIcons = `
    <tr>
      <td style="padding: 15px 0; text-align: center;">
        <a href="https://www.instagram.com/nationalfundforwomen" target="_blank" style="display: inline-block; margin: 0 12px; width: 32px; height: 32px;">
        ...
        <a href="https://www.tiktok.com/@nationalfundforwomen" target="_blank" style="display: inline-block; margin: 0 12px; width: 32px; height: 32px;">
          <svg width="32" height="32" viewBox="0 0 24 24" fill="#FFFFFF" style="display: block;">
            <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-5.2 1.74 2.89 2.89 0 012.31-4.64 2.93 2.93 0 01.88.13V9.4a6.84 6.84 0 00-1-.05A6.33 6.33 0 005 20.1a6.34 6.34 0 0010.86-4.43v-7a8.16 8.16 0 004.77 1.52v-3.4a4.85 4.85 0 01-1-.1z"/>
          </svg>
        </a>
        <a href="https://www.facebook.com/nationalfundforwomen" target="_blank" style="display: inline-block; margin: 0 12px; width: 32px; height: 32px;">
          <svg width="32" height="32" viewBox="0 0 24 24" fill="#FFFFFF" style="display: block;">
