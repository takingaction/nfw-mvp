...
export const MOCK_PRODUCTS: MockProduct[] = [
  {
    ...
    cardDescription: "Beautiful handcrafted ceramic mug perfect for your morning coffee or tea. Features a classic design with comfortable grip.",
  ...
  },
  {
    ...
    cardDescription: "Eco-friendly canvas tote bag with NFW branding. Perfect for shopping or everyday use. Made from sustainable materials.",
  ...
  },
  {
    ...
    cardDescription: "Premium lined notebook with NFW cover design. Includes matching pen. Great for journaling or note-taking.",
  ...
  },
  {
    ...
    cardDescription: "Insulated stainless steel water bottle. Keeps drinks cold for 24 hours or hot for 12 hours. BPA-free.",
  ...
  },
  {
    ...
    cardDescription: "Set of 3 organic lip balms in different flavors. Made with natural ingredients. Long-lasting moisture.",
  ...
  },
  {
    ...
    cardDescription: "Fun NFW sticker pack with various designs. Waterproof and durable. Perfect for laptops or water bottles.",
