...
VALUES (
  'Pricing Final CTA',
  'pricing_final_cta',
  '{"headline":"Ready to feel supported?","subheadline":"Join thousands of women who have already found relief, connection and real support through NFW. Your journey starts here.","items":[{"title":"Microgrants","sub":"Up to $1,000 in support","icon_color":"wisteria"},{"title":"Exclusive Perks","sub":"Save $500+ per year","icon_color":"wisteria"},{"title":"Community","sub":"50,000+ women strong","icon_color":"wisteria"}],"cta_label":"Become a Member Today","cta_url":"/auth/sign-up","footnote":"Join in minutes. No credit card required to browse.","background":"aubergine"}'::jsonb,
  true
);
