      ...
      .then((data) => {
        if (data) {
          setFaqData({
            ...defaultData,
            ...data,
            faq_sections: data.faq_sections || defaultData.faq_sections,
            still_have_questions_buttons: data.still_have_questions_buttons || defaultData.still_have_questions_buttons,
          });
        }
      })
      .catch(console.error);
        ...
        <div className="py-16 lg:py-24">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="animate-pulse space-y-12">
              {[1, 2, 3].map((i) => (
                <div key={i}>
                  <div className="h-6 w-40 bg-nfw-blackberry/10 rounded mb-6" />
                  <div className="space-y-4">
                    {[1, 2, 3].map((j) => (
                      <div key={j} className="h-20 bg-nfw-blackberry/5 rounded" />
                    ))}
                  </div>
                </div>
              ))}
