        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4 p-5 rounded-2xl border border-[#2d1239]/10 bg-[#d4f1ad]/20">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-[#2d1239]/70 hover:text-[#2d1239] transition-colors text-sm underline"
                    >
                ...
                <div className="flex items-start gap-4 p-5 rounded-2xl border border-[#2d1239]/10 bg-[#b2d1ee]/20">
                  ...
                  <div>
                    ...
                    <p className="text-[#2d1239]/70 text-sm">
              ...
              {/* Quick Links */}
              <div>
                <p className="text-xs font-semibold text-[#2d1239]/40 uppercase tracking-widest mb-4">
                  ...
                  <>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                          <label className="block text-sm font-semibold text-[#2d1239] mb-2">
                            Your name
                          </label>
                          <input
                            type="text"
