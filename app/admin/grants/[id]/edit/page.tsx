...
export default function EditGrantCyclePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const data = await res.json()
      if (!res.ok) throw new Error(data.error || 'Failed to update grant cycle')
  ...
  return (
    <main className="min-h-screen p-8 bg-gray-50">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-[#2d1239] mb-2">Edit Grant Cycle</h1>
          <p className="text-gray-600">Update the details of this grant cycle.</p>
        </div>
