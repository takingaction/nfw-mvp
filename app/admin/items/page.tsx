...
if (itemsError) {
  ...
  // Fetch categories for quick stats
    ...
    <main className="min-h-screen p-8 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-4xl font-bold">Manage Store Items</h1>
            <p className="text-gray-600 mt-2">Add, edit, and manage Zero Dollar Store inventory</p>
          </div>
                  ...
                  <td className="px-6 py-4">
                    <div className="text-sm">
                      <div className={`font-medium ${
                        item.quantity_available === 0 ? 'text-red-600' : 'text-gray-900'
                      }`}>
