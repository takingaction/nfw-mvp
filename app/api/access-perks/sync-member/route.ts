...
import { syncAccessMember, profileToAccessMember } from '@/lib/access-perks/member-sync'
  ...
  try {
    ...
    await supabase
      ...
      .update({ 
        ...
        access_perks_member_id: memberData.userId.replace(/[^a-zA-Z0-9]/g, '').toUpperCase()
      })
      .eq('id', userId)
