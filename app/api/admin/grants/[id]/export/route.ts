...
const COLUMN_LABELS: Record<string, string> = {
  ...
  ai_evaluated_at: "AI Evaluated At",
  ai_invalidated_at: "AI Skipped At",
  ...
  try {
    ...
    for (const grant of grants || []) {
      ...
      const row = [
        ...
        grant.ai_relevance || "",
        (grant.ai_reasoning || "").replace(/\s+/g, " ").trim(),
        grant.ai_evaluated_at ? formatDateTime(grant.ai_evaluated_at) : "",
        grant.ai_invalidated_at ? formatDateTime(grant.ai_invalidated_at) : "",
