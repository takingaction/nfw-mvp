        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex gap-2 overflow-x-auto pb-3 mb-10 scrollbar-hide justify-center flex-wrap">
            {[
              ...
              <button
                key={pill}
                className={`px-4 py-1.5 rounded-full whitespace-nowrap text-sm font-semibold transition-colors ${i === 0 ? "bg-[#2d1239] text-[#fffef1]" : "bg-white text-[#2d1239] border border-[#2d1239]/20 hover:bg-[#bcafcf]/20"}`}
              >
                {pill}
              </button>
            ))}
