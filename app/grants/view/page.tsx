...
export default function MicrograntsPage() {
  return (
    <main className="min-h-screen bg-white">
      {/* ── HERO ── */}
      <div className="relative bg-[#fffef1] overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-2">
                <Link
                  href="/grants/apply"
                  className="group relative inline-flex items-center justify-center px-8 py-4 bg-[#2d1239] text-[#fffef1] rounded-xl font-bold text-lg overflow-hidden transition-all shadow-lg hover:bg-[#2d1239]/90"
                >
                  Apply Today →
                </Link>
                <Link
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              >
                ...
                <div className="p-5">
                  <p className="text-xs text-[#2d1239]/40 mb-2">
                    {grant.closing}
                  </p>
                  <h3
                    className="text-lg font-black text-[#2d1239] mb-2"
                    style={{ fontFamily: "Montserrat, sans-serif" }}
                  >
                    {grant.title}
                  </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              >
                ...
                <div
                  className={`inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br ${color} rounded-full mb-6 shadow-lg group-hover:scale-110 group-hover:rotate-12 transition-all duration-300`}
                >
      ...
      {/* ── HOW MUCH YOU CAN RECEIVE — icons allowed ── */}
      <div className="relative bg-white py-16 lg:py-24 overflow-hidden">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-4">
              {[
                ...
                >
                  <div
                    className={`flex-shrink-0 w-8 h-8 ${tier.check} rounded-full flex items-center justify-center mt-0.5`}
                  >
      ...
      {/* ── SUCCESS STORIES — image only, no icons ── */}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between mb-10">
            <div>
              ...
              <h2
                className="text-4xl sm:text-5xl font-black text-[#2d1239] leading-tight"
                style={{ fontFamily: "Montserrat, sans-serif" }}
              >
                Success Stories &
                <br />
              ...
              <p className="text-[#2d1239]/60 mt-2 text-lg">
              ...
              >
                ...
                <div className="p-5">
                  <span
                    ...
                    style={{
                      backgroundColor: `${story.accent}40`,
                      color: "#2d1239",
                    }}
                  >
                    {story.category}
                  ...
                  <h3
                    className="font-black text-[#2d1239] mb-3 line-clamp-2"
                    style={{ fontFamily: "Montserrat, sans-serif" }}
                  >
                    {story.title}
                  </h3>
