            ...
            <div className="space-y-4">
              {[
                ...
                >
                  ...
                  <div>
                    <p className="font-black text-[#2d1239] text-lg" style={{ fontFamily: 'Montserrat, sans-serif' }}>
      ...
      <div className="bg-gradient-to-br from-[#2d1239] to-[#4a1f5c] py-20 lg:py-32 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          ...
          <p className="text-[#bcafcf] text-sm mt-6">
            ...
            <Link href="/auth/sign-up" className="underline hover:text-white transition-colors">
              Join free today →
            </Link>
          </p>
        </div>
