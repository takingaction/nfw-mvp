...
export default function MicrograntsPage() {
  return (
    <main className="min-h-screen bg-nfw-dove">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="font-sans text-xl text-nfw-blackberry/70 max-w-lg leading-relaxed">
      ...
      <div className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="font-serif text-4xl sm:text-5xl text-nfw-aubergine mb-4 leading-tight">
              Grants that help with real-life needs
            </h2>
            <p className="font-sans text-lg text-nfw-blackberry/70">
      ...
      {/* HOW IT WORKS */}
      <div className="bg-nfw-wisteria py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <p className="font-ui text-xs font-black tracking-[0.06em] uppercase text-white/70 mb-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              >
                ...
                <p className="font-sans text-nfw-blackberry/70">{description}</p>
              </div>
            ))}
          </div>
        </div>
...
<h2 className="font-serif text-4xl sm:text-5xl text-nfw-aubergine mb-4 leading-tight">
      ...
      {/* SUCCESS STORIES */}
      <div className="py-16 lg:pb-40 bg-nfw-dove">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between mb-10">
            <div>
              ...
              <h2 className="font-serif text-4xl sm:text-5xl text-nfw-aubergine leading-tight">
                Success Stories and Everyday Wins
              </h2>
              <p className="font-sans text-nfw-blackberry/60 mt-2 text-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              >
                ...
                <div className="p-5">
                  <span
                    className="inline-block font-ui text-xs font-black tracking-[0.06em] uppercase px-2.5 py-1 mb-3"
                    style={{
      ...
      <div className="bg-nfw-aubergine py-20 lg:py-32">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="font-serif text-4xl sm:text-5xl lg:text-6xl text-nfw-dove mb-6">
            Ready to get the support you deserve?
          </h2>
          <p className="font-serif text-xl text-nfw-blackberry/80 mb-8 max-w-2xl mx-auto">
