...
const allBenefits = [
  ...
  {
    label: "Perks & discounts platform",
    free: false,
    contributing: true,
    founding: true,
  },
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            {plans.map((plan) => (
              ...
              >
                ...
                <div className="mb-3">
                  <span
                    className={`text-4xl font-black ${plan.highlighted ? "text-[#fdf493]" : "text-[#2d1239]"}`}
                    style={{ fontFamily: "Montserrat, sans-serif" }}
                  >
                    {plan.price}
                  </span>
                  <span
                    className={`text-sm ml-1 ${plan.highlighted ? "text-[#bcafcf]" : "text-[#2d1239]/50"}`}
                  >
                    {plan.period}
                  </span>
                </div>
                ...
                <p
                  className={`text-sm mb-6 ${plan.highlighted ? "text-[#bcafcf]" : "text-[#2d1239]/60"}`}
                >
                  {plan.description}
                </p>
                ...
                <ul className="space-y-3">
                  {plan.features.map((feature) => (
                    <li key={feature} className="flex items-start gap-3">
                      ...
                      <span
                        className={`text-sm ${plan.highlighted ? "text-[#fffef1]" : "text-[#2d1239]/70"}`}
                      >
                        {feature}
                      </span>
                    </li>
          ...
          <div className="text-center bg-[#fffef1] rounded-3xl p-10 border border-[#2d1239]/10">
            ...
            <p className="text-[#2d1239]/40 text-sm mt-4">
              ...
              <Link
                href="/auth/login"
                className="underline hover:text-[#2d1239] transition-colors"
              >
                Sign in
              </Link>
            </p>
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-2xl border border-[#2d1239]/10 overflow-hidden shadow-sm">
            ...
            <div className="grid grid-cols-4 bg-[#2d1239] px-6 py-4">
              <div className="text-[#bcafcf] text-sm font-semibold">
                Benefit
              </div>
              <div className="text-center text-[#bcafcf] text-sm font-semibold">
                Free
              </div>
              <div className="text-center text-[#fdf493] text-sm font-semibold">
                Contributing
              </div>
              <div className="text-center text-[#d4f1ad] text-sm font-semibold">
                Founding
              </div>
            </div>
            ...
            {allBenefits.map((benefit, i) => (
              ...
              >
                <div className="text-sm text-[#2d1239] font-medium">
                  {benefit.label}
                </div>
                <div className="flex justify-center">
                  {benefit.free ? (
                    <div className="w-5 h-5 rounded-full bg-[#d4f1ad] flex items-center justify-center">
                      <Check className="w-3 h-3 text-[#2d1239]" />
                    </div>
                  ) : (
                    <div className="w-5 h-5 rounded-full bg-[#2d1239]/10 flex items-center justify-center">
                      <span className="text-[#2d1239]/30 text-xs">—</span>
                    </div>
                  )}
                </div>
                <div className="flex justify-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-4">
              {[
                ...
                >
                  <div
                    className={`flex-shrink-0 w-8 h-8 ${item.check} rounded-full flex items-center justify-center mt-0.5`}
                  >
