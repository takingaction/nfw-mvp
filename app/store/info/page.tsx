...
const testimonials = [
  { quote: "I couldn't believe it was free. I got a stroller for my baby and didn't pay a cent. NFW changed everything for us.", name: 'Keisha, 28', role: 'Home Health Aide' },
  { quote: "The Zero Dollar Store helped me get school supplies for my kids when I had nothing left in my budget.", name: 'Carmen, 35', role: 'Restaurant Worker' },
  { quote: "I claimed a baby monitor I desperately needed. It arrived in two days. I cried happy tears.", name: 'Amara, 31', role: 'Nursing Student' },
  { quote: "Free items that actually matter — not junk. Real things women need every day.", name: 'Diane, 44', role: 'Administrative Assistant' },
  { quote: "I was skeptical at first but it's real. I've claimed three items and every one arrived as described.", name: 'Priya, 38', role: 'Childcare Worker' },
  { quote: "This is the most generous thing I've ever been part of. I tell every woman I know about it.", name: 'Tanya, 52', role: 'Retired Teacher' },
]

const categories = ['All', 'Baby & Kids', 'Health & Wellness', 'Home Essentials', 'Food & Groceries', 'Education', 'Personal Care']
...
export default function ZeroDollarStoreInfoPage() {
  ...
  const previewItems = items.length > 0 ? items.slice(0, 6) : [
    { id: '1', name: 'Baby Monitor', category: 'Baby & Kids', color: '#d4f1ad', emoji: '👶' },
    { id: '2', name: 'Vitamins & Supplements', category: 'Health & Wellness', color: '#b2d1ee', emoji: '💊' },
    { id: '3', name: 'School Supplies Bundle', category: 'Education', color: '#fdf493', emoji: '📚' },
    { id: '4', name: 'Grocery Gift Card', category: 'Food & Groceries', color: '#d4f1ad', emoji: '🛒' },
    { id: '5', name: 'Personal Care Kit', category: 'Personal Care', color: '#bcafcf', emoji: '🧴' },
    { id: '6', name: 'Home Essentials Set', category: 'Home Essentials', color: '#b2d1ee', emoji: '🏠' },
  ]
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#2d1239]/10 border border-[#2d1239]/20 rounded-full text-sm">
                ...
                <span className="text-[#2d1239] font-semibold">Free items for NFW members — no catch</span>
              </div>
              <h1
              ...
              <p className="text-xl text-[#2d1239]/70 max-w-lg leading-relaxed">
                The Zero Dollar Store is exclusively for NFW members. Browse real items — baby gear, groceries, health essentials, and more — and claim them for free. No strings attached.
              </p>
            ...
            <div className="relative">
              <div className="relative rounded-3xl overflow-hidden aspect-[4/3] shadow-2xl">
                ...
                <div className="absolute bottom-5 left-5 bg-white/95 backdrop-blur-sm rounded-2xl px-5 py-4 shadow-xl">
                  <p className="text-2xl font-black text-[#2d1239]" style={{ fontFamily: 'Montserrat, sans-serif' }}>$0</p>
                  <p className="text-xs text-[#2d1239]/60 font-medium">Every item, every time</p>
                </div>
                <div className="absolute top-5 right-5 bg-[#fdf493] rounded-2xl px-4 py-3 shadow-lg">
                  <p className="text-xs font-black text-[#2d1239]" style={{ fontFamily: 'Montserrat, sans-serif' }}>Members</p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between mb-4">
            <div>
              ...
              <p className="text-[#2d1239]/60">A preview of what members can claim — new items added regularly.</p>
            </div>
            <Link
              href="/store"
            ...
            {previewItems.map((item) => (
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  <div>
                    <span
                      ...
                      style={{ backgroundColor: `${item.color}40`, color: '#2d1239' }}
                    >
                      {item.category}
                    </span>
                    <h3
                ...
                <div className="flex items-center justify-between">
                  <span className="text-lg font-black text-[#2d1239]" style={{ fontFamily: 'Montserrat, sans-serif' }}>$0.00</span>
                  <Link
                    href="/store"
      ...
      <div className="relative bg-[#bcafcf] py-16 lg:py-24 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <p className="text-xs font-semibold text-[#2d1239]/50 uppercase tracking-widest mb-3">Simple, fast, and free</p>
            <h2
              className="text-4xl sm:text-5xl font-black text-[#2d1239] mb-4 leading-tight"
              style={{ fontFamily: 'Montserrat, sans-serif' }}
            >
              How the Zero
              <br />Dollar Store works
            </h2>
            <p className="text-[#2d1239]/70 text-lg">Claiming a free item should feel easy. Here&apos;s how it works.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { step: '01', title: 'Browse available items', description: 'Explore what\'s currently in the store — from baby gear to groceries to health essentials.', color: 'from-[#d4f1ad] to-[#b2d1ee]', icon: '🛍️' },
              { step: '02', title: 'Claim your item', description: 'Select what you need and claim it. One item at a time, while supplies last.', color: 'from-[#fdf493] to-[#d4f1ad]', icon: '✅' },
              { step: '03', title: 'Receive it at your door', description: 'Your item ships directly to you. No payment, no hidden fees. Just a gift from NFW.', color: 'from-[#b2d1ee] to-[#bcafcf]', icon: '📦' },
      ...
      <div className="relative bg-white py-16 lg:py-24 overflow-hidden">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-xs font-semibold text-[#2d1239]/40 uppercase tracking-widest mb-3">Made for real needs</p>
              <h2
                className="text-4xl sm:text-5xl font-black text-[#2d1239] mb-4 leading-tight"
                style={{ fontFamily: 'Montserrat, sans-serif' }}
              >
              ...
              <p className="text-lg text-[#2d1239]/70 mb-8">
                The Zero Dollar Store exists because sometimes you just need something and the budget isn&apos;t there. NFW members get access to real items that make a real difference.
              </p>
              <Link
                href="/auth/sign-up"
            ...
            <div className="space-y-4">
              {[
                { color: '#d4f1ad', title: 'Real items, not samples', description: 'Everything in the store is a full-size, useful item — not promotional samples or junk.' },
                { color: '#fdf493', title: 'No hidden costs ever', description: 'Zero dollars means zero dollars. No shipping fees, no handling charges, no surprises.' },
                { color: '#b2d1ee', title: 'New items added regularly', description: 'The store refreshes with new items so there\'s always something worth checking back for.' },
              ].map((item) => (
                <div
                  key={item.title}
                ...
                >
                  <div className="flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center mt-0.5" style={{ backgroundColor: item.color }}>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-[#2d1239]/60 text-lg">
              These are real moments from women who found something they needed in the Zero Dollar Store.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {testimonials.map((t) => (
              ...
              >
                <p className="text-[#2d1239]/70 text-sm leading-relaxed mb-6">&ldquo;{t.quote}&rdquo;</p>
      ...
      <div className="bg-gradient-to-br from-[#2d1239] to-[#4a1f5c] py-20 lg:py-32 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          ...
          <p className="text-xl text-[#bcafcf] mb-8 max-w-2xl mx-auto">
            The Zero Dollar Store is one of many ways NFW supports women across the country. Become a member to get access.
          </p>
          <div className="grid sm:grid-cols-3 gap-6 mb-10 max-w-3xl mx-auto">
            {[
              { color: 'bg-[#d4f1ad]', title: 'Free Items', sub: 'No cost, ever' },
              { color: 'bg-[#fdf493]', title: 'Ships to You', sub: 'Delivered to your door' },
              { color: 'bg-[#b2d1ee]', title: 'Members Only', sub: 'Exclusive access' },
            ].map((item) => (
          ...
          >
            <span className="absolute inset-0 bg-gradient-to-r from-[#fdf493] to-[#d4f1ad] opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
            <span className="relative">Join NFW — It&apos;s Free to Start →</span>
          </Link>
          <p className="text-[#bcafcf] text-sm mt-6">
            Already a member?{' '}
            <Link href="/store" className="underline hover:text-white transition-colors">Browse the store now →</Link>
          </p>
        </div>
      </div>
