          ...
          <div className="relative w-full max-w-md bg-white shadow-2xl flex flex-col h-full overflow-y-auto">
            ...
            <div className="p-6 border-b border-gray-100 bg-gray-50">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-black text-[#2d1239] text-base">
                    ...
                    >
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          ...
                          ></span>
                          <span className="text-sm font-semibold text-[#2d1239]">
                            {option.label}
                          </span>
                        </div>
                        <p className="text-xs text-gray-400 mt-0.5">
                ...
                {currentStatus === "active" &&
                  !selected.subscription_status?.includes("active") && (
                    <p className="text-xs text-[#2d1239]/60 mt-2 bg-[#fdf493]/30 rounded-lg p-2">
                      ⚠️ This will manually activate the member without a Stripe
                  ...
                  {[
                    ...
                    >
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          {option.value && (
                            <Shield className="w-3 h-3 text-[#2d1239]" />
                          )}
                          <span className="text-sm font-semibold text-[#2d1239]">
                            {option.label}
                          </span>
