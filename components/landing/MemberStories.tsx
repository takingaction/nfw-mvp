      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-[#2d1239]/70 max-w-3xl mx-auto">
            Every member has a story. Here are just a few of the thousands we've
          ...
          {stories.map((story, index) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                <div className="mb-3">
                  <div className="text-2xl font-black font-bold">
                    {story.name}
                  </div>
              ...
              <div
                className={`absolute top-0 left-0 right-0 h-2 ${story.bgColor}`}
              ></div>
            </div>
          ))}
        </div>
