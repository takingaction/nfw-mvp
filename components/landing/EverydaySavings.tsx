...
export default function EverydaySavings() {
  ...
  return (
    <div className="relative bg-white py-16 lg:py-24 pb-24 overflow-hidden">
      {" "}
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-6 lg:order-2 relative">
            ...
            <p className="text-lg text-[#2d1239]/80">
              Members get access to thousands of discounts on things you already
              buy. These aren't gimmicks—they're real savings that make your
